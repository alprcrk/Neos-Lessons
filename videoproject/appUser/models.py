...
class UserInfo(models.Model):
    ...
    package = models.CharField(("Paket Tipi"), max_length=50,null=True,blank=True)
    end_package = models.CharField(("Bitiş Tarihi"), max_length=50, null=True,blank=True)

    def days_remaining(self):
        today = date.today()
        remaining = self.end_package - today
